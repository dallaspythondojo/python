...
result is the building key and value that stores the random number
session is the random amount
result_dictionary is telling the user what the game rolled up
"""
